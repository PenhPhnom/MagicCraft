...
public class Potteryprototype : MonoBehaviour
{
    ...
    void GeneratePrototype()
    {
        ...
        mesh.uv = UV.ToArray();
        //SideCount = m.mesh.vertices.Length;
    ...
    void GenerateCircle(int _layer)
    {
        ...
        for (float i = 0; i <= Mathf.PI * 2 + EachAngle; i += EachAngle)
        {
            ...
            Debug.DrawLine(v1,v2, new Color(1, 1, 1));
            Debug.DrawLine(v2, v3, new Color(1, 1, 1));
            Debug.DrawLine(v3, v4, new Color(1, 1, 1));
            ...
            UV_inside.Add(uv3);
            UV_inside.Add(uv4);
            Debug.DrawLine(uv1, uv2,new Color(1,1,1));
            Debug.DrawLine(uv2, uv3, new Color(1, 1, 1));
            Debug.DrawLine(uv3, uv4, new Color(1, 1, 1));
        }
